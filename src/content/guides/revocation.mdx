...
```typescript
import { createStatusList, generateKeyPair } from "credat";
...
```typescript
import { createStatusListCredential } from "credat";
...
```typescript
import { setRevocationStatus, createStatusListCredential } from "credat";
