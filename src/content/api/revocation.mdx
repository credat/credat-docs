...
console.log(`${all.length} status list(s) in storage`);
```
...
- [Credential revocation guide](/docs/guides/revocation) — End-to-end walkthrough: create, host, revoke, and check status lists
- [Enforce delegation constraints](/docs/guides/constraints) — Complement revocation with runtime constraint checks
